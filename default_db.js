...
async function seedUsers(client) {
    try {
        ...
        client.query(`INSERT INTO tbl_users (usertype, employeetype, firstname, lastname, name, email, username, password)
...
async function seedUserTypes(client) {
    try {
        ...
        client.query(`INSERT INTO tbl_user_types (id, usertype) VALUES ('410544b2-4001-4271-9855-fec4b6a6442a', 'Admin');`);
        client.query(`INSERT INTO tbl_user_types (id, usertype, isaccount) VALUES ('729ccecc-b8eb-4aee-b87c-4d2635637c95', 'Employee', true);`);
...
async function seedEmpTypes(client) {
    try {
        await client.query(`CREATE EXTENSION IF NOT EXISTS "uuid-ossp"`);
        // Create the "users" table if it doesn't exist
        const createTable = await client.query(`
...
async function seedEmployeeTime(client) {
    try {
        await client.query(`CREATE EXTENSION IF NOT EXISTS "uuid-ossp"`);
        // Create the "users" table if it doesn't exist
        const createTable = await client.query(`
...
async function seedStateCity(client) {
    try {
        ...
        client.query(`INSERT INTO tbl_states (state_sub_id, state_name) VALUES (1, 'ANDHRA PRADESH'),(2, 'ASSAM'),(3, 'ARUNACHAL PRADESH'),(4, 'BIHAR'),(5, 'GUJARAT'),(6, 'HARYANA'),(7, 'HIMACHAL PRADESH'),(8, 'JAMMU & KASHMIR'),(9, 'KARNATAKA'),(10, 'KERALA'),(11, 'MADHYA PRADESH'),(12, 'MAHARASHTRA'),(13, 'MANIPUR'),(14, 'MEGHALAYA'),(15, 'MIZORAM'),(16, 'NAGALAND'),(17, 'ORISSA'),(18, 'PUNJAB'),(19, 'RAJASTHAN'),(20, 'SIKKIM'),(21, 'TAMIL NADU'),(22, 'TRIPURA'),(23, 'UTTAR PRADESH'),(24, 'WEST BENGAL'),(25, 'DELHI'),(26, 'GOA'),(27, 'PONDICHERY'),(28, 'LAKSHDWEEP'),(29, 'DAMAN & DIU'),(30, 'DADRA & NAGAR'),(31, 'CHANDIGARH'),(32, 'ANDAMAN & NICOBAR'),(33, 'UTTARANCHAL'),(34, 'JHARKHAND'),(35, 'CHATTISGARH');`);

        const createSubTable = await client.query(`
...
async function seedLeave(client) {
    try {
        // Create the "users" table if it doesn't exist
        const createTable = await client.query(`
...
async function main() {
    ...
    await seedUserTypes(client);
    await seedEmpTypes(client);
    await seedUsers(client);
    await seedStateCity(client);
    await seedEmployeeTime(client);
    await seedLeave(client);
